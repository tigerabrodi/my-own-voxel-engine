...
export const EDGE_VERTEX_INDICES: ReadonlyArray<readonly [number, number]> = [
  [0, 1],
  [1, 3],
  [3, 2],
  [2, 0],
...
export const EDGE_MASKS = new Int32Array([
...
export const TRIANGLE_TABLE: ReadonlyArray<readonly number[]> = [
  [-1],
  [0, 3, 8, -1],
  [0, 9, 1, -1],
  [3, 8, 1, 1, 8, 9, -1],
